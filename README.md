...
Most commands return JSON by default because the CLI is intended for agents and
scripts. Use `--output human` for setup checks, status summaries, read results,
and dry-run previews that are easier to scan:
